...
class User(BaseModel):
    ...
    poi_search_restrict_method: str | None = None
    poi_search_day_number: int = 0
    poi_search_residual_day_number: int = 0
    poi_search_total_number: int = 0
    poi_search_residual_total_number: int = 0
