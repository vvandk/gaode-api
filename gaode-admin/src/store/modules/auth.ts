...
export interface UserState {
  ...
  last_login?: string
  last_ip?: string
  poi_search_restrict_method?: string
  poi_search_day_number?: number
  poi_search_residual_day_number?: number
  poi_search_total_number?: number
  poi_search_residual_total_number?: number
}
